...
<div class="container">
    <div class="row">
        <div class="col-xs-12 col-lg-3 zeroPadding">
            <div class="cxRanking" style="display: none;">
...
<div class="lista">
    <div class="list-group">
        <?php foreach($vaga as $vagas) { ?>
            <a data-toggle="modal" data-target="#opts_<?=$vagas->id?>" class="list-group-item list-group-item-action flex-column align-items-start">
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            <div class="row">
                                                <div class="col-md-3"><label for="titulo"><h6>Título:</h6></label></div>
                                                <div class="col-md-9"><input type="text" class="form-control" value="<?=$vagas->titulo?>" name="titulo" id="titulo"></div>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-12">
                                            <div class="row">
                                                <div class="col-md-3"><label for="salario"><h6>Sálario:</h6></label></div>
                                                <div class="col-md-9"><input type="number" min="0" step="0.01" class="form-control" value="<?=$vagas->salario?>" name="salario" id="salario"></div>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-12">
                                            <div class="row">
                                                <div class="col-md-3"><label for="local"><h6>Local:</h6></label></div>
                                                <div class="col-md-9"><input type="text" class="form-control" value="<?=$vagas->local?>" name="local" id="local"></div>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-12">
                                            <div class="row">
                                                <div class="col-md-3"><label for="area"><h6>Area:</h6></label></div>
                                                <div class="col-md-9">
                                        ...
                                        <div class="form-group col-md-12">
                                            <div class="row"><div class="col-md-12"><textarea class="form-control" name="descricao" id="descricao" rows="5" style="resize: none;"><?=$vagas->descricao?></textarea></div></div>
                                            <input type="hidden" value="<?=$vagas->id?>" name="id">
                                        </div>        
                                    </div>
                                </div>                                        
                            </div>
