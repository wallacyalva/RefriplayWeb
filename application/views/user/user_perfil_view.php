...
<script>
    function editarPostModal(id) {
        $.ajax({
            url: "https://wa-studio.com/uchi/usuario/getPost",
            type: 'POST',
            dataType: 'json',
            data: {
                idPost: id
    ...
    function excluirPost(id) {
        $.ajax({
            url: "https://wa-studio.com/uchi/usuario/excluirPost",
            type: 'POST',
            dataType: 'json',
            data: {
                idPost: id
    ...
    function alterarFixacao(id_post, isFixed) {
        if(isFixed){
            $.ajax({
                url: "https://wa-studio.com/uchi/usuario/desfixarPost",
                type: 'POST',
                dataType: 'json',
                data: {
                    id_post: id_post
            ...
            $.ajax({
                url: "https://wa-studio.com/uchi/usuario/fixarPost",
                type: 'POST',
                dataType: 'json',
                data: {
                    id_post: id_post
