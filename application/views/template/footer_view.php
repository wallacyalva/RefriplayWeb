   ...
   $("#btnRanking").on("click", function() {
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                $("#resultadoRanking").append("<div class='d-flex flex-row item'><div class='foto'><img src='https://wa-studio.com/uchi/assets/images/" + element.avatar + "' alt='Avatar Ranking'></div><div class='infor relative' style='min-width: 75%;'><a href='https://wa-studio.com/uchi/usuario/perfil/" + element.id + "' class='btVerPerfil text-uppercase btn btn-sm caixaBordaVerde'>Ver Perfil</a><h3 class='nome'>" + element.name + " " + element.surname + "</h3><small>Ingressou: " + element.created + "</small><p>" + element.aboutme + "</p></div></div>");
                });
