<div class="container" style="margin-bottom: 14px;">
    <div class="row cxInfor">
        ...
        <div class="col-xs-12 col-md-7 col-xl-8 zeroPadding bioBt">
            ...
            <p><?=$usuario->aboutme ? $usuario->aboutme : "Você ainda não escreveu nada sobre sí, altere seus dados clicando nos botão abaixo."?></p>
            <div class="btInline">
                <div class="text-uppercase caixaBordaAzul">Dados Pessoais<a data-toggle="modal" data-target="#editarInformacoes"></a></div>
                <div class="text-uppercase caixaBordaAmarelo">Clientes<a data-toggle="modal" data-target="#editarPortifolio"></a></div>
                <div class="text-uppercase caixaBordaVermelho">Orçamentos<a href="#"></a></div>
