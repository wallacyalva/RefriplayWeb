...
<head>
    ...
    <link rel="icon" href="<?=images_url()?>top.png" type="image/x-icon">
            ...
            <div class="row">
                <div class="col-2 logo">
                    <a href="<?=$this->session->userdata("is_user") ? base_url("usuario") : base_url("empresa")?>">
                        <img src="<?=images_url()?>logo.png" style="width: 165px;" alt="Rede UCHI" class="d-none d-md-inline-block">
                    </a>
                </div>
                <div class="col-6">
<form action="<?php if($this->session->userdata("is_user")){ base_url ('usuario\Pesquisar');} ?>" method="post">
                ...
                <div class="col-4 d-flex justify-content-end itens">
                    <div class="notificacoes d-flex align-items-stretch justify-content-center">
                        ...
                        <div class="item">
                            ...
                            <div class="caixa notificacoes" <?php if(count($notificacoes)=='0'){ ?>style="display:none;"<?php  } ?> >
                                <div class="title text-uppercase">
                                    <h6>Notificações</h6>
                                    <a href="<?=base_url()?>usuario/vizualizarNotificacaoTodas/<?php if(!isset($emp)){$user->id;}else{$emp->id;} ?>/notificacoes">Marcar tudo como lido</a>
                                </div>
                        ...
                        <div class="item">
                            <img src="<?=images_url()?>pessoas.png" alt="Notificações">
                    ...
                    <div class="perfil">
                        <?=$this->session->userdata("is_user") ? $user->name." ".$user->surname : $emp->name?>
                        <br>
