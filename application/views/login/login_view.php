...
<!-- JAVASCRIPT JS  -->
        ...
        <link rel="icon" href="<?= base_url() ?>assets/images/logologin.png" type="image/x-icon">
        <!-- END META SECTION -->
    ...
    <body>
        ...
        <div class="login-container" style="background-image: url(<?= base_url() ?>assets/images/loginrefri.png); background-size: cover;">
            
            <div class="login-box animated fadeInDown">
                 <div class="login-logo"> <img src="<?= base_url() ?>assets/images/logologin.png" alt="" style="width: 30%;"></div>
                <div class="login-body">
                    <div class="login-title"> <img src="<?= base_url() ?>assets/images/namelogo.png" alt="" style="width: 35%;"></div>
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            ...
                            <button class="btn btn-primary btn-lg btn-block btn-acessar" id="acessar" style="box-shadow: 3px 3px 3px #bdbaba;">Acessar</button>
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            <button class="btn btn-primary btn-lg btn-block btn-acessar hide" id="load" disabled="disabled"><i class='fa fa-spinner fa-spin '></i> Acessando...</button>
                            <button class="btn btn-primary btn-lg btn-block btn-acessar" id="acessar" style="background: #00b7ff;border-color: #00b7ff;margin-top: -5px; box-shadow: 3px 3px 3px #bdbaba;">Acessar com Facebook</button>
                            <input type="submit" style="position: absolute; left: -9999px">
                        </div>
                    </div>
                    </form>
                ...
                <!-- <div class="login-footer">
                    <div class="pull-left">
                    <strong>  &copy; 2018 Refriplay</strong>
                    </div>
