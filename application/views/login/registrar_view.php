...
<html lang="en" class="body-full-height">
    ...
    <body>
        <div class="registration-container" style="background-image: url(https://wa-studio.com/uchi/assets/images/filhote.jpg); background-position: center; background-blend-mode: soft-light; background-repeat: space; background-size: cover;">  
